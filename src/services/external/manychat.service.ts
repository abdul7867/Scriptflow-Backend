...
// ═══════════════════════════════════════════════════════════════════════════
// LEGACY SENDER (DEPRECATED - Use manychatStateService for pull-based delivery)
// ═══════════════════════════════════════════════════════════════════════════

/**
 * @deprecated Use manychatStateService.setReadyState() instead.
 * This function is kept for backward compatibility but is no longer called.
 * The pull-based delivery model uses custom fields (sc_status, sc_last_script, sc_last_image)
 * to avoid Meta 24-hour window restrictions.
 */
export async function sendToManyChat(payload: ManyChatPayload): Promise<void> {
  logger.warn('[DEPRECATED] sendToManyChat called - use manychatStateService instead');
  ...
  // NOTE: This function no longer updates fields due to migration to pull-based delivery
  // Field updates are now handled by manychatStateService
  logger.info(`[DEPRECATED] sendToManyChat skipped for ${payload.subscriber_id} - use manychatStateService`);
}
